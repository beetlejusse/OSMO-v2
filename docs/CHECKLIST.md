...
- [x] 🚧 Confirm which basket assets Reflector prices — testnet Pulse oracle (`CAVLP5…4D6HLP`) mirrors pubnet: AQUA, EURC confirmed on screenshot 2026-07-05. **VELO not yet sighted — verify before mainnet.**
- [x] 🚧 Decide: mock test tokens approved — self-issued classic assets `TAQUA/TVELO/TUSDC/TEURC` (ADR-012)
...
- [x] Deploy OracleRouter + Factory + Ecosystem Folio to testnet (addresses in `.stellar/nebula-testnet.json`; folio `CAG2JR…VR4Y`)
